...
namespace DartaChalani
{
    public partial class SidePanel : UserControl
    {
        ...
        private static SidePanel _instance;
        public static Control Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new SidePanel();
                return _instance;
            }
        }

        private void btn_sp_tippani_Click(object sender, EventArgs e)
        {
        ...
        private void btn_sp_darta_Click(object sender, EventArgs e)
        {
        ...
        private void btn_sp_consultancy_Click(object sender, EventArgs e)
        {
